<?php
    ...
    include 'InserrerServices.php';        // Fonction pour ajouter
        ...
        if (in_array($imageFileType, $extensions_autorisees)) {
            ...
            if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                try {
                    ...
                    ajouterServices($target_file, $nom, $description, $libelle, $prix);
...
<head>
    ...
    <title>Ajouter des nouveaux services produit</title>
</head>
<body>
